...
ax.plot(df["total_bill"], model.predict(scaler.transform(df[['total_bill']])), color="#d15858", linewidth=2)
...
st.markdown('<div class="card"><h3>Enter the total bill amount:</h3>', unsafe_allow_html=True)
bill = st.slider("",
    min_value=min_bill,
    max_value=max_bill,
